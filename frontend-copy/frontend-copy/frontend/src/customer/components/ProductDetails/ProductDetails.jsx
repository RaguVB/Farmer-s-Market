...
const product = {
  name: "Motor toys Mania",
   price: "$192",
   href: "#",
   breadcrumbs: [
     { id: 1, name: "Soft Toys", href: "#" },   //men
     { id: 2, name: "Birds", href: "#" },      //Clothing
   ],
   images: [
     {
       src: "https://media.istockphoto.com/id/1438419394/photo/yellow-elephant-doll-things-with-red-background.jpg?s=612x612&w=0&k=20&c=UX7MKppbcehBIsf13NhxqY340nR_0UCKBZyutEB-Qg4=",
       alt: "Explore the best soft toys in this world!!!",
     },
   ],
   description:
     'To explore the best soft toys in this world !!!',
   highlights: [
